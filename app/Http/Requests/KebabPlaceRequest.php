...
class KebabPlaceRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            "opening_hours_monday" => ["required", "array"],
            "opening_hours_tuesday" => ["required", "array"],
            "opening_hours_wednesday" => ["required", "array"],
            "opening_hours_thursday" => ["required", "array"],
            "opening_hours_friday" => ["required", "array"],
            "opening_hours_saturday" => ["required", "array"],
            "opening_hours_sunday" => ["required", "array"],
